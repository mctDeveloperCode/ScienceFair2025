...
void matrixSetup() {
  ...
  digitalWrite(2, ANIM_ENABLED ? HIGH : LOW);
}
...
byte font[95][8] = { {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // SPACE
                     {0x10,0x18,0x18,0x18,0x18,0x18,0x00,0x18}, // EXCL
                     {0x28,0x28,0x08,0x00,0x00,0x00,0x00,0x00}, // QUOT
                     {0x00,0x0a,0x7f,0x14,0x28,0xfe,0x50,0x00}, // #
                     {0x10,0x38,0x54,0x70,0x1c,0x54,0x38,0x10}, // $
                     {0x00,0x60,0x66,0x08,0x10,0x66,0x06,0x00}, // %
                     {0x30,0x48,0x48,0x30,0x50,0x8a,0x8c,0x72}, // &
                     ...
                     {0x00,0x78,0x40,0x40,0x70,0x40,0x40,0x78}, // E
...
// Marquee text 
#define SIZE 255
char text[SIZE + 1] = "KATIE & MATISYN !";
int len = strlen(text);
...
void matrixLoop() 
{
  ...
  while (Serial.available() && count < SIZE) {
    ...
    if (input == 't' && count == 0) {
      ...
      digitalWrite(2, ANIM_ENABLED ? HIGH : LOW);
      Serial.println("toggle animation");
    ...
    // Unprcessed characters get appended to the text string
    text[count] = input;
    count++;
  }
